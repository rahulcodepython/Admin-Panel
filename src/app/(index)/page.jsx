...
import { PiChartLineUpBold, FiUser, MdDevices, BiDollar, BiSolidUpArrow, MdOutlineBarChart, RiProjectorLine, VscGraphLine, BiTimeFive, IoIosArrowUp, IoIosArrowDown } from '@/data/icons/icons'
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-12 gap-5 my-4 mx-auto container'>
            <div className='w-full flex flex-col items-start justify-evenly gap-3 h-full text-black bg-slate-200 rounded-lg p-5 col-span-12 md:col-span-4'>
                ...
                <button className='bg-black p-2 text-white uppercase font-bold text-xs w-full rounded-md mt-2'>
                    view sales
                </button>
            </div>

            <div className='w-full flex flex-col justify-evenly gap-3 bg-slate-200 text-black rounded-lg p-5 col-span-12 md:col-span-8'>
                ...
                <div className='flex justify-between gap-4 w-full'>
                    <div className='flex gap-2'>
                        <div className='text-white bg-black h-full w-[3.25rem] rounded-md flex items-center justify-center'>
            ...
            <div className='w-full h-full flex flex-col items-start justify-evenly gap-5 p-5 rounded-md text-black bg-slate-200  col-span-12 md:col-span-6 xl:col-span-4'>
                <span className='text-xl font-semibold'>
                    Weekly Overview
                </span>
                <div className='w-full h-full flex items-end justify-around'>
                    ...
                    <div className='h-[37%] w-2 bg-slate-400 rounded-full'></div>
                    <div className='h-[57%] w-2 bg-slate-400 rounded-full'></div>
                    <div className='h-[45%] w-2 bg-slate-400 rounded-full'></div>
                    <div className='h-[75%] w-2 bg-black rounded-full'></div>
                    <div className='h-[57%] w-2 bg-slate-400 rounded-full'></div>
                    <div className='h-[40%] w-2 bg-slate-400 rounded-full'></div>
                    <div className='h-[65%] w-2 bg-slate-400 rounded-full'></div>
                </div>
                ...
                <button className='bg-black text-white p-2 uppercase font-bold text-xs w-full rounded-md mt-2'>
                    Details
                </button>
            </div>

            <div className='w-full h-full flex flex-col justify-evenly gap-8 items-start p-5 rounded-md text-black bg-slate-200  col-span-12 md:col-span-6 xl:col-span-4'>
                <span className='text-xl font-semibold'>
                    Total Earning
                </span>
                ...
                <div className='flex flex-col items-start gap-4 w-full'>
                    <div className='flex items-center justify-between w-full'>
                        <div className='flex items-center gap-3'>
                            <div className='p-2 bg-black bg-opacity-5 rounded-md'>
            ...
            <div className='w-full grid grid-cols-2 gap-5 col-span-12 xl:col-span-4'>
                <div className='bg-slate-200 p-5 rounded-md text-black flex flex-col items-start justify-evenly gap-2'>
                    <div className='rounded-full p-2 text-white bg-black text-center mb-2'>
            ...
            <div className='w-full bg-slate-200 rounded-md grid grid-cols-2 divide-x py-5 divide-slate-500 col-span-12 lg:col-span-8'>
                <div className='px-5 flex flex-col items-start gap-8 md:gap-4 w-full'>
                    <div className='text-black text-xl font-semibold'>Deposit</div>
                    <div className='flex items-center justify-between w-full'>
                        <div className='flex items-center gap-4'>
                ...
                <div className='px-5 flex flex-col items-start gap-4 w-full'>
                    <div className='text-black text-xl font-semibold'>Withdraw</div>
                    <div className='flex items-center justify-between w-full'>
                        <div className='flex items-center gap-4'>
            ...
            <div className='w-full p-5 bg-slate-200 rounded-md flex flex-col items-start justify-evenly gap-4 col-span-12 lg:col-span-4'>
                <div className='text-black text-xl font-semibold'>Deposit</div>
                <div className='flex items-center justify-between w-full'>
                    <div className='flex items-center gap-4'>
